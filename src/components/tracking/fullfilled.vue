...
import FulfilledData from '~/pages/tracking/fulfilleddata.json';

// Fetching data from json file
const fulfilledData = FulfilledData;

// V-Model Variables
const datas = ref<Tracking[]>(fulfilledData as unknown as Tracking[]);
...
<template>
    <div class="w-full bg-accentwhite pb-3 px-5 drop-shadow-md rounded-lg dark:bg-primarydark">  
        <h3 class="text-lg text-left dark:text-accentwhite ml-4 mt-5 mb-5">Fulfilled</h3>
        <!-- Parent Table -->
        <DataTable 
        :value="datas"
        stripedRows
