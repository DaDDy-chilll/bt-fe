...
<template>
  <div>
        ...
        >
          ...
          <Column field="status" header="Status">
            <template #body="slotProps">
              <span
                :class="{
                  'bg-green-300 px-2 py-1 rounded-md':
                    slotProps.data.status === 'No issues',
                  'bg-yellow-300 px-2 py-1 rounded-md':
                    slotProps.data.status === 'Warning',
                  'bg-red-300 px-2 py-1 rounded-md':
          ...
          <Column field="memo" header="Memo">
            <template #body="slotProps">
              <span
                class="cursor-pointer hover:text-accent1"
                @click="showMemos(slotProps.data.memo)"
    ...
    <Dialog
      v-model:visible="showMemoDialog"
      header="Memos"
      :modal="true"
      :closable="true"
      :style="{ width: '500px' }"
